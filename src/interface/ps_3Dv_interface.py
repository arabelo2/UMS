...
def main():
    ...
    if mode == "1D":
        ...
        ax = plt.gca()
        apply_plot_style(ax, title="1D Rayleigh-Sommerfeld Simulation for Rectangular Piston Transducer", xlabel=xlabel, ylabel="Normalized pressure magnitude")
        ...
        if args.plot_3dfield:
            ...
            if not x_is_vec:
                ...
                ax.set_title(f"3D Visualization of Ultrasound Pressure Field for Rectangular Piston at x = {x_vals}")
                apply_plot_style(ax, title=f"3D Visualization of Ultrasound Pressure Field for Rectangular Piston at x = {x_vals}", xlabel="y (mm)", ylabel="z (mm)", zlabel="Pressure")
            elif not y_is_vec:
                ...
                ax.set_ylabel("z (mm)")
                ax.set_zlabel("Pressure")
                ax.set_title(f"3D Visualization of Ultrasound Pressure Field for Rectangular Piston at y = {y_vals}")
                apply_plot_style(ax, title=f"3D Visualization of Ultrasound Pressure Field for Rectangular Piston at y = {y_vals}", xlabel="x (mm)", ylabel="z (mm)", zlabel="Pressure")
            elif not z_is_vec:
                ...
                ax.set_ylabel("y (mm)")
                ax.set_zlabel("Pressure")
                ax.set_title(f"3D Visualization of Ultrasound Pressure Field for Rectangular Piston at z = {z_vals}")
                apply_plot_style(ax, title=f"3D Visualization of Ultrasound Pressure Field for Rectangular Piston at z = {z_vals}", xlabel="x (mm)", ylabel="y (mm)", zlabel="Pressure")
        ...
        ax.set_ylabel("y (mm)")
        ax.set_zlabel("z (mm)")
        ax.set_title("3D Rayleigh-Sommerfeld Simulation for Rectangular Piston Transducer")
        apply_plot_style(ax, title="3D Rayleigh-Sommerfeld Simulation for Rectangular Piston Transducer", xlabel="x (mm)", ylabel="y (mm)", zlabel="z (mm)")
        cb = fig.colorbar(ax.collections[0], ax=ax, label="Normalized pressure magnitude")
        apply_plot_style(ax, colorbar_obj=cb)
