...
Example usage:
  1) Steering and focusing with plot:
     python interface/delay_laws3Dint_interface.py --Mx=4 --My=4 --sx=0.5 --sy=0.5 --thet=20 --phi=0 --theta2=45 --DT0=10 --DF=10 --c1=1480 --c2=5900 --plt=y
     
  2) Steering and focusing without plot:
     python interface/delay_laws3Dint_interface.py --Mx=4 --My=4 --sx=0.5 --sy=0.5 --thet=20 --phi=0 --theta2=45 --DT0=10 --DF=10 --c1=1480 --c2=5900 --plt=n
...
def main():
    ...
    parser.add_argument("--thet", type=safe_float, default=20.0, help="Array angle with interface (deg). Default: 20")
    parser.add_argument("--phi", type=safe_float, default=0.0, help="Steering angle phi (deg). Default: 0")
    parser.add_argument("--theta2", type=safe_float, default=45.0, help="Refracted steering angle in second medium (deg). Default: 45")
    ...
    td = run_delay_laws3Dint_service(args.Mx, args.My, args.sx, args.sy,
                                     args.thet, args.phi, args.theta2,
